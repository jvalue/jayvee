...
export const generateAction = async (fileName: string, opts: GenerateOptions): Promise<void> => {
    const services = createOpenDataLanguageServices(NodeFileSystem).OpenDataLanguage;
...
export default function(): void {
    ...
    const fileExtensions = OpenDataLanguageLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
